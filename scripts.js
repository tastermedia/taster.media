    ...
    .then(function(data) {
      ...
      function initButtons() {
        ...
        try{
          ...
          // Drop any older keys on first load so they don't linger.
          localStorage.removeItem('taster.size');
          localStorage.removeItem('taster.size.v2');
        }catch(e){}
        applySizePx(savedPx);
        if(sizeSlider){
